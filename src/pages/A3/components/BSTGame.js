        ...
        <div className="interactiveInterface">
          <div className="playercontainer">
            ...
            <div className="options">
              <Button variant="outline-dark" id="BST_Insert_One">
                insert 5
              </Button>
              <Button variant="outline-dark" id="BST_Remove_Two">
                remove 2
              </Button>
              <Button variant="outline-dark" id="BST_Insert_Three">
                insert 25
              </Button>
            </div>
          </div>
          ...
          <div className="AIcontainer">
            ...
            <div className="options">
              <Button variant="outline-dark" id="A3_BST_GameOption_AI_One">
                remove 31
              </Button>
              <Button variant="outline-dark" id="A3_BST_GameOption_AI_Two">
                insert 15
              </Button>
              <Button variant="outline-dark" id="A3_BST_GameOption_AI_Three">
                remove 12
              </Button>
            </div>
          </div>
